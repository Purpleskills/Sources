# Generated by Django 2.0.1 on 2019-02-07 17:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default=None, null=True, upload_to=learn.models.Instructor.GetPhotoFilename)),
            ],
        ),
        migrations.AddField(
            model_name='course',
            name='price',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='INR', max_digits=8, null=True),
        ),
        migrations.AddField(
            model_name='course',
            name='price_currency',
        ...
        migrations.AddField(
            model_name='course',
            name='thumbnail',
            field=models.ImageField(blank=True, default=None, null=True, upload_to=learn.models.Course.GetThumbFilename),
        ),
        migrations.AlterField(
            model_name='course',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='learn.CourseCategory'),
        ),
        migrations.AlterField(
            model_name='course',
            name='description',
        ...
        migrations.AlterField(
            model_name='course',
            name='difficulty',
            field=models.CharField(choices=[(learn.models.DifficultyChoice('Beginner'), 'Beginner'), (learn.models.DifficultyChoice('Intermediate'), 'Intermediate'), (learn.models.DifficultyChoice('Difficult'), 'Difficult'), (learn.models.DifficultyChoice('Very Difficult'), 'Very Difficult')], max_length=16, null=True),
        ),
        migrations.AlterField(
            model_name='course',
            name='duration',
        ...
        migrations.AlterField(
            model_name='course',
            name='provider',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='learn.CourseProvider'),
        ),
        migrations.AlterField(
            model_name='course',
            name='status',
        ...
        migrations.AlterField(
            model_name='course',
            name='subcategory',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='learn.CourseSubCategory'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='courseuserrelation',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='schedule.Event'),
        ),
        migrations.AddField(
            model_name='courseuserrelation',
            name='user',
