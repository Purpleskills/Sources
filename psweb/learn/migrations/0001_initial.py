    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.CharField(choices=[(learn.models.DifficultyChoice('Beginner'), 'Beginner'), (learn.models.DifficultyChoice('Intermediate'), 'Intermediate'), (learn.models.DifficultyChoice('Advanced'), 'Advanced')], max_length=16, null=True)),
                ...
                ('price', djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=None, default_currency='INR', max_digits=8, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CourseProvider',
            fields=[
                ...
                ('logo', models.ImageField(upload_to=learn.models.CourseProvider.GetLogoFilename)),
                ('url', models.URLField()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='learn.Course')),
        ...
        migrations.AddField(
            model_name='course',
            name='tags',
            field=models.ManyToManyField(to='learn.CourseTag'),
        ),
    ]
